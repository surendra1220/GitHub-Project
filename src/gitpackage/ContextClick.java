...
public class ContextClick {
	...
	public static void main (String[] args) throws Exception
	{
		...
		act.contextClick(rightclick).sendKeys(Keys.DOWN).sendKeys(Keys.DOWN).sendKeys(Keys.DOWN).sendKeys(Keys.DOWN).sendKeys(Keys.DOWN).sendKeys(Keys.DOWN).sendKeys(Keys.RETURN).build().perform();
		/*
